...
describe Wix::Hive::REST::Contacts do
  ...
  it '.update_contact_company' do
    ...
    expect(contacts).to receive(:perform_with_object).with(:put, "/v1/contacts/#{contact_id}/company", Wix::Hive::Contact, {}, {company: company_name}.to_json).and_return(instance_double(Faraday::Response, body: 'mock'))
